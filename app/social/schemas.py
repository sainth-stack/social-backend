...
class ContentPlanJobProgress(BaseModel):
    current: int = 0
    total: int = 0
    message: str = ""


class ContentPlanJobStatusResponse(BaseModel):
    jobId: str
    status: str  # pending | running | completed | failed
    progress: Optional[ContentPlanJobProgress] = None
    result: Optional["ContentPlanGenerateResponse"] = None
